module Multiplier_RR (Ready,
 ...
 sky130_fd_sc_hd__inv_2 _112_ (.A(net1),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _113_ (.A(net9),
    .Y(_107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _115_ (.A(net11),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _116_ (.A(net10),
    .Y(_110_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__nor4_1 _117_ (.A(net7),
    .B(net6),
    .C(net5),
    .D(net4),
    .Y(_111_),
 ...
 sky130_fd_sc_hd__or3_2 _119_ (.A(_106_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dlymetal6s2s_1 _120_ (.A(_069_),
    .X(_070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22o_1 _122_ (.A1(\M1_Datapath.multiplicand[3] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _123_ (.A(net3),
    .Y(_072_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 _124_ (.A(_072_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dlymetal6s2s_1 _125_ (.A(_069_),
    .X(_073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__a22o_1 _126_ (.A1(\M1_Datapath.multiplicand[2] ),
    .A2(_073_),
    .B1(net6),
    .B2(_071_),
    .X(_066_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_1 _127_ (.A(_050_),
    .X(_049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__a22o_1 _128_ (.A1(\M1_Datapath.multiplicand[1] ),
    .A2(_073_),
    .B1(net5),
    .B2(_071_),
    .X(_065_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_1 _129_ (.A(_050_),
    .X(_048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__a22o_1 _130_ (.A1(\M1_Datapath.multiplicand[0] ),
    .A2(_073_),
    .B1(net4),
    .B2(_071_),
    .X(_064_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_1 _131_ (.A(_050_),
    .X(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _141_ (.A(_050_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__a32o_1 _142_ (.A1(_073_),
    .A2(_077_),
 ...
 sky130_fd_sc_hd__clkbuf_1 _144_ (.A(_080_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__a32o_1 _145_ (.A1(_069_),
    .A2(_077_),
 ...
 sky130_fd_sc_hd__inv_2 _148_ (.A(net13),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__buf_1 _149_ (.A(net20),
    .X(_083_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2bb2a_1 _150_ (.A1_N(\M1_Datapath.multiplicand[3] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__buf_1 _151_ (.A(net19),
    .X(_085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _153_ (.A(\M1_Datapath.multiplicand[0] ),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _154_ (.A(net17),
    .Y(_088_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _169_ (.A(_080_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__mux2_1 _170_ (.A0(net18),
    .A1(_008_),
    .S(_081_),
    .X(_057_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _172_ (.A(_097_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__mux2_1 _173_ (.A0(net17),
    .A1(_007_),
    .S(_081_),
    .X(_056_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_1 _184_ (.A(_072_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__or2_1 _185_ (.A(net13),
    .B(_077_),
    .X(_100_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _186_ (.A(_100_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__nor2_1 _187_ (.A(net3),
    .B(\M0_Controller.state ),
    .Y(net12),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_4 _229_ (.D(_054_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dfrtp_4 _230_ (.D(_055_),
    .Q(net16),
    .RESET_B(_039_),
    .CLK(net2),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_4 _232_ (.D(_057_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dfrtp_1 _233_ (.D(_058_),
    .Q(net19),
    .RESET_B(_042_),
    .CLK(net2),
    .VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dfrtp_2 _234_ (.D(_059_),
    .Q(net20),
    .RESET_B(_043_),
    .CLK(net2),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_2 input1 (.A(Start),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__buf_1 input10 (.A(word2[2]),
    .X(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dlymetal6s2s_1 input11 (.A(word2[3]),
    .X(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__buf_4 input2 (.A(clock),
    .X(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 input3 (.A(reset),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_2 input4 (.A(word1[0]),
    .X(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__buf_1 input5 (.A(word1[1]),
    .X(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__buf_1 input6 (.A(word1[2]),
    .X(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_2 input7 (.A(word1[3]),
    .X(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__buf_1 input8 (.A(word2[0]),
    .X(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__buf_1 input9 (.A(word2[1]),
    .X(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
